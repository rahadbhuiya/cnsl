...
ATT&CK technique mapping, STIX 2.1 export + built-in TAXII 2.1 server,
Wazuh/OSSEC and Kafka/Redis integration, Grafana/Prometheus metrics,
PostgreSQL migration, compliance reporting (SOC2/ISO27001/PCI-DSS),
